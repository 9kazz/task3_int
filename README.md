...
## Тестовая программа:
В репозитории расположена программа test.asm позволяющая проверить корректность работы Debug Viewer. Она изменяет значения регистров и флагов и заполняет стек, таким образом, можно увидеть, что в рамке Debug Viewer изменения отражаются корректно.
